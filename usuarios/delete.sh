...
# ============================================================
#        ⚜ YAKU-MULTI-SCRIPT — USER MANAGER ⚜
...
#        • Limpiar límites de Yaku-Multi-Script
...
banner() {
    ...
    echo -e "${CYAN}╔══════════════════════════════════════════════════════════════╗${RESET}"
    echo -e "${CYAN}║${MAGENTA}          ⚜ YAKU-MULTI-SCRIPT ⚜                       ${CYAN}║${RESET}"
...
es_usuario_admin() {
    ...
    # Si Yaku-Multi-Script tiene registrado el usuario,
...
while true; do
    ...
    case "$OPCION" in
        ...
        0)
            ...
            echo
            echo -e "${CYAN}╔══════════════════════════════════════════════════════════════╗${RESET}"
            echo -e "${CYAN}║${GREEN}             ✔ YAKU USER MANAGER                       ${CYAN}║${RESET}"
