...
# ==============================================================
#
# Archivo : /etc/yaku-multi-script/protocolos/bhttp.sh
...
crear_servicio() {
    ...
    cat > "$UNIT" <<EOF
[Unit]
Description=Yaku-Multi-Script BHTTP Server
...
mostrar_menu() {
    ...
    echo -e "${GRAY}  Protocolo BHTTP • Yaku-Multi-Script v${VERSION}${RESET}"
    ...
    echo -e "${GRAY}  Yaku-Multi-Script • Privanox VPN${RESET}"
