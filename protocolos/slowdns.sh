...
#
# Configuración:
# /etc/yaku-multi-script/config.conf
# ==============================================================
...
header() {
    ...
    echo -e \
        "${CYAN}║${RESET}                 ${GRAY}Yaku-Multi-Script v$VERSION${RESET}                    ${CYAN}║${RESET}"
...
[Unit]
Description=Yaku-Multi-Script SlowDNS Server
...
install_slowdns() {
    ...
    # ----------------------------------------------------------
    # Configuración Yaku-Multi-Script
    # ----------------------------------------------------------
...
while true; do
    ...
    echo -e \
        "${GRAY}Yaku-Multi-Script • SlowDNS Manager v$VERSION${RESET}"
