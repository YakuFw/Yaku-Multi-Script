#!/bin/bash
# Yaku-Multi-Script Telegram Bot - instalación / actualización del bot
set -euo pipefail
...
install_bot(){
  clear
  echo -e "${C}╔══════════════════════════════════════════════════════════════╗${X}"
  echo -e "${C}║${X} ${W}\e[1m                 BOT TELEGRAM YAKU-MULTI-SCRIPT${X}                 ${C}║${X}"
  echo -e "${C}╚══════════════════════════════════════════════════════════════╝${X}"
  echo
...
[Unit]
Description=Yaku-Multi-Script Telegram Bot
