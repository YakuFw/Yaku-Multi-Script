# 🛡️ Yaku-Multi-Script — Premium Edition
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/YakuFw/Yaku-Multi-Script/main/install.sh)
```
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/YakuFw/Yaku-Multi-Script/main/update.sh)
```
...
Yaku-Multi-Script no requiere Key ni activación externa. La instalación es directa y no depende de un servidor de licencias.
